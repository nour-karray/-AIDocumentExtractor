...
LABS = [
    {
        "name": "Laboratoire d'Analyses Medicales Dr. Fatma Jmal Hamza",
        "doctor": "Dr. SMAOUI NADIA",
        "address": "Route de Teniour Km 7 Imm Derbel 1er etage Chihia Sfax",
    },
    {
        "name": "Laboratoire Medical de la Mediterranee",
        "doctor": "Dr. YASMINE KHALED",
        "address": "Centre Medical de Mahres - Rue des Martyrs - 3060 Mahres",
    },
    {
        "name": "Laboratoire d'Analyses Medicales Dr. Boubaker Sadok Benzina",
        "doctor": "Dr. AFFES ABDELKADER",
        "address": "Mahres - Route de Gabes - Tel 70 034 033",
    },
    {
        "name": "BioLab Sante Sfax",
        "doctor": "Dr. RANIA TRABELSI",
        "address": "Avenue Habib Bourguiba, Sfax",
    },
]

PATIENTS = [
    ("GADDOUR IMTINENE HADRICH", "F", "11835063/00"),
    ("KRAIEM AMER", "M", "12-150"),
    ("JALEL BEN SLIMANE", "M", "12-4567"),
    ("NOUR EDDINE BEN SALAH", "M", "22-587"),
    ("MARIEM MANSOUR", "F", "CP994"),
    ("SARRA HAMMAMI", "F", "P-7781"),
    ("MOHAMED ALI FERCHICHI", "M", "A-3309"),
    ("FATMA ZOUARI", "F", "M-9021"),
]
